...
const EditSecteur = ({ showEdit, closeEdit, data }: any) => {
    ...
    const formik = useFormik({
        ...
        validate: (values: any) => {
            ...
            if (!values?.secteurname) {
                errors.secteurname = "Entrez un nom de secteur";
            }
            if (!values?.image) {
                ...
                if (!supportedFormats.includes(fileType)) {
                    errors.image = "Format d'image non pris en charge. Veuillez télécharger un fichier JPG, JPEG, PNG, WEBP ou GIF.";
                    values.image = null;
                }
                else if (fileSize > maxFileSize) {
                    errors.image = "La taille du fichier doit être inférieure à 1 Mo.";
                    values.image = null;
                }
                else {
                            ...
                            <form action="" className=" md:w-full" onSubmit={formik.handleSubmit}>
                                <div className='flex flex-col pt-4'>
                                    ...
                                    <input
                                        ...
                                        value={formik.values.secteurname}
                                        onChange={formik.handleChange}
                                    />
                                    {formik.errors.secteurname && typeof formik.errors.secteurname === 'string' && (
                                ...
                                <div className='flex flex-col pt-4 md:pt-8 w-full'>
                                    ...
                                    <div className="flex items-center justify-center w-full">
                                        <label
                                            htmlFor="logo-upload"
                                            className={`flex flex-col items-center justify-center w-full ${formik?.values?.image ? "h-60 md:h-60" : "h-32 md:h-40"} border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-100`}
                                        >
                                            <>
                                                {
                                                    formik?.values?.image ?
                                ...
                                <div className='flex flex-col pt-4 md:pt-8 md:w-full'>
