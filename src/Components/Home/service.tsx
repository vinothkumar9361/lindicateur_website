      ...
      <>
         <div className="bg-gray-100  pt-14">
            ...
            <div className="mt-4 py-10 sm:px-20">
               <div className="container mx-auto grid grid-cols-1 md:gap-10 lg:grid-cols-4">
                  <div className="flex flex-col box_shadow_light w-full">
                     <div className="">
                        <Image src={serviceImg1} alt="Img" className="h-32 w-full" />
                     </div>
                     <div className="bg-white p-4 text-center sm:content-center w-full h-28">
                  ...
                  <div className="flex flex-col box_shadow_light w-full">
                     <div className="">
                        <Image src={serviceImg2} alt="Img" className="h-32 w-full" />
                     </div>
                     <div className="bg-white p-4 text-center sm:content-center w-full h-28">
                  ...
                  <div className="flex flex-col box_shadow_light w-full">
                     <div className="">
                        <Image src={serviceImg3} alt="Img" className="h-32 w-full" />
                     </div>
                     <div className="bg-white p-4 text-center sm:content-center w-full h-28">
                  ...
                  <div className="flex flex-col box_shadow_light w-full">
                     <div className="">
                        <Image src={serviceImg4} alt="Img" className="h-32 w-full" />
                     </div>
                     <div className="bg-white p-4 text-center sm:content-center w-full h-28">
                  ...
                  <div className="flex flex-col box_shadow_light w-full">
                     <div className="">
                        <Image src={serviceImg5} alt="Img" className="h-32 w-full" />
                     </div>
                     <div className="bg-white p-4 text-center sm:content-center w-full h-28">
                  ...
                  <div className="flex flex-col box_shadow_light w-full">
                     <div className="">
                        <Image src={serviceImg6} alt="Img" className="h-32 w-full" />
                     </div>
                     <div className="bg-white p-4 text-center sm:content-center w-full h-28">
                  ...
                  <div className="flex flex-col box_shadow_light w-full">
                     <div className="">
                        <Image src={serviceImg7} alt="Img" className="h-32 w-full" />
                     </div>
                     <div className="bg-white p-4 text-center sm:content-center w-full h-28">
                  ...
                  <div className="flex flex-col box_shadow_light w-full">
                     <div className="">
                        <Image src={serviceImg8} alt="Img" className="h-32 w-full" />
                     </div>
                     <div className="bg-white p-4 text-center sm:content-center w-full h-28">
