    ...
    return (
        <>
            <div className="result-data bg-white flex flex-col justify-center gap-5 p-4 mt-6">
                            ...
                            <>
                                {
                                    item?.adBgType == "poster" ?
                                        <div className="ad-card cursor-pointer">
                                            <Image src={AdImg} alt="img" className="w-full h-full" width={900} height={580} />
                                        </div>
                                        :
                                        <div className="ad-banner cursor-pointer">
                                            ...
                                            <div className={`ad-background`}>
                                                <Image src={BannerBackground} alt="banner" width={900} height={580} />
                                            </div>
                                        </div>
                                }
                            </>
                ...
                <div className="flex flex-wrap justify-between gap-5 p-4 mt-6">
                    {
